...
import classes from "./folder-add-button.module.css"
import FolderAddModal from "@/components/modal-compound/components/folder-add-modal"
...
export default function FolderAddButton() {
  ...
  return (
    <>
      {isToggle && <FolderAddModal onCloseModal={handleCloseToggle} />}
      <button className={classes.addButton} onClick={handleOpenToggle}>
        폴더 추가
